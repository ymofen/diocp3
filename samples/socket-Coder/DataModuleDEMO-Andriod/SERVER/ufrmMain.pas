...
uses
  uFMMonitor, uDIOCPStreamCoder, uRunTimeINfoTools, iocpTask, DZipTools;
...
begin
  ...
  try
    s := '0123456789';
    lvStream.Write(s[1], Length(s) * 2);
    TDZipTools.ZipStream(lvStream, lvStream);

    TDZipTools.UnZipStream(lvStream, lvStream);
